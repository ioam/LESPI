...
def select(filedata, cache={}, verbose=False, **kwargs):
    """
    Convenience function for selecting and loading Layouts from
    ...
    Layout. Note that the selection arguments are stored under the
    'Metadata' path of the returned Layout.
